...
`, [myTiles.transparency16], TileScale.Sixteen);
            case "level18":
            case "level18":return tiles.createTilemap(hex`0100010001`, img`
. 
`, [myTiles.transparency16,myTiles.tile4], TileScale.Sixteen);
            case "level19":
...
`, [myTiles.transparency16], TileScale.Sixteen);
            case "level20":
            case "level20":return tiles.createTilemap(hex`0100010001`, img`
. 
`, [myTiles.transparency16,myTiles.tile4], TileScale.Sixteen);
            case "level6":
            case "level6":return tiles.createTilemap(hex`0a00070001010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101`, img`
. . . . . . . . . . 
. . . . . . . . . . 
. . . . . . . . . . 
. . . . . . . . . . 
...
`, [myTiles.transparency16], TileScale.Sixteen);
            case "level24":
            case "level24":return tiles.createTilemap(hex`0100010001`, img`
. 
